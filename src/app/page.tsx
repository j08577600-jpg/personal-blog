  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-20">
      ...
      <section className="relative max-w-3xl py-16 pl-5">
        ...
        <p className="mb-4 text-sm uppercase tracking-[0.24em] text-text-muted">
          极简技术博客
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 rounded-full bg-accent px-5 py-2.5 text-sm font-medium text-white hover:bg-accent-hover transition-colors duration-150"
          >
            查看文章
          </Link>
          <Link
            href="/about"
            className="inline-flex items-center gap-2 rounded-full border border-accent text-accent px-5 py-2.5 text-sm font-medium hover:bg-accent-subtle transition-colors duration-150"
          >
            关于我
          </Link>
          <Link
            href="/mdx-plan"
            className="inline-flex items-center gap-2 rounded-full border border-border text-text-secondary px-5 py-2.5 text-sm font-medium hover:border-accent hover:text-accent transition-colors duration-150"
          >
            下一步计划
          </Link>
        </div>
      ...
      <section className="grid gap-10 border-t border-border py-14 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div>
          <div className="mb-8 flex items-end justify-between gap-4">
            ...
            <Link href="/blog" className="text-sm text-text-muted hover:text-accent transition-colors duration-150">
              查看全部
            </Link>
          </div>
